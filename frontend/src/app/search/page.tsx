...
const SearchContent = () => {
  ...
  const [pageMetadata, setPageMetadata] = useState({
    title: 'Tìm kiếm phim | AllDrama',
    description: 'Tìm kiếm hàng ngàn bộ phim và series chất lượng cao tại AllDrama.'
  });

  useEffect(() => {
    const metadata = generateSearchMetadata(searchQuery, selectedGenre);
    setPageMetadata({
      title: metadata.title as string || 'Tìm kiếm phim | AllDrama',
      description: metadata.description || 'Tìm kiếm hàng ngàn bộ phim và series chất lượng cao tại AllDrama.'
    });
